require 'fileutils'
require_relative 'rubymine_version'
...
module ConsoleHelpers
  class Pad
    ...
    def initialize(file)
      ...
      @file = Pathname(GenericHelpers.sanitize_for_link(file).first)
    ...
    def print_link(line = nil)
      ConsoleHelpers.print_file_link(file, *line)
      self
    end
